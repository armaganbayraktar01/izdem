...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <span class="logo-mini"><b><?= site_settings('title_short')?></b>App</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b><?= site_settings('title')?></b>App</span>
            </a>
            ...
            <div class="navbar-custom-menu">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <li>
                        ...
                        <li><!-- start message -->
                            <a href="#">
                            <div class="pull-left">
                                <img src="<?=admin_public_url('dist/img/user2-160x160.jpg')?>" class="img-circle" alt="User Image">
                            </div>
                            <h4>
                                Support Team
                        ...
                        <li>
                            <a href="#">
                            <div class="pull-left">
                                <img src="<?=admin_public_url('dist/img/user3-128x128.jpg')?>" class="img-circle" alt="User Image">
                            </div>
                            <h4>
                        ...
                        <li>
                            <a href="#">
                            <div class="pull-left">
                                <img src="<?=admin_public_url('dist/img/user4-128x128.jpg')?>" class="img-circle" alt="User Image">
                            </div>
                            <h4>
                                Developers
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <img src="<?=admin_public_url('dist/img/user2-160x160.jpg')?>" class="user-image" alt="User Image">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    <li class="header">UYGULAMALAR</li>

                    <?php foreach ($menus_sidebar as $menu_url => $menu_content): ?>
                        <li class="<?=route(1) == $menu_url ? 'active' : null ?> treeview">
                            <a href="<?=admin_url($menu_url)?>">
                                <i class="fa fa-<?= $menu_content['icon']?>"></i> <span><?= $menu_content['title'] ?></span>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="<?=route(1) == $submenu_url ? 'active' : null ?>">
                                    <a href="<?=admin_url($submenu_url)?>">
                                        <i class="fa fa-<?= $submenu_content['icon'] == '' ? 'circle-o' : $submenu_content['icon'] ?>"></i>
